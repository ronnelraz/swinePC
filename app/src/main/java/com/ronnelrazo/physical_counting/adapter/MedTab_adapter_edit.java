...
public class MedTab_adapter_edit extends RelativeLayout {
    ...
    public MedTab_adapter_edit(Context context, String str_auditno) {
        super(context);
    ...
    private void putangina(){
        ...
        API.getClient().edit_med(str_auditno).enqueue(new Callback<Object>() {
            @Override
...
//        textView.setBackgroundColor(Color.parseColor("#FFFFFF"));
    ...
    protected void updateChanges(String counting,String remark,String org_code,String audit_no,String farm_org,String feed_code,String variance,String unpost,String actual){
        ...
        API.getClient().update_med(counting,remark,org_code,audit_no,farm_org,feed_code,variance,unpost,actual, SharedPref.getInstance(context).getUser()).enqueue(new Callback<Object>() {
            @Override
            public void onResponse(Call<Object> call, retrofit2.Response<Object> response) {
                try {
