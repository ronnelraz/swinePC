...
import com.ronnelrazo.physical_counting.adapter.BreederTab_adapter;
...
//
//                    if(success){
//                        Toast.makeText(getActivity(), "putangina", Toast.LENGTH_SHORT).show();
////                        loading.setVisibility(View.GONE);
//                        for (int i = 0; i < result.length(); i++) {
//                            JSONObject object = result.getJSONObject(i);
//                            Toast.makeText(getActivity(),  object.getString("locationCode"), Toast.LENGTH_SHORT).show();
