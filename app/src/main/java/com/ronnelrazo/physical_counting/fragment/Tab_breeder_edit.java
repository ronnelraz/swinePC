...
import com.ronnelrazo.physical_counting.adapter.BreederTab_adapter_edit;
...
//    LinearLayout loading;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View view =  new BreederTab_adapter_edit(getActivity(),str_audit_no); //inflater.inflate(R.layout.fragment_breeder,parent,false);
