...
import com.ronnelrazo.physical_counting.adapter.Adapter_Feed_edit;
...
public class Tab_feed_edit extends Fragment {
    ...
    public static List<model_feed_edit> list = new ArrayList<>();
    ...
    private void loadFeedData(String str_audit_no) {

        list.clear();
        API.getClient().edit_feed(str_audit_no).enqueue(new Callback<Object>() {
            @Override
                ...
                try {
                    ...
                    if(success){
                        ...
                        for (int i = 0; i < result.length(); i++) {
                            ...
                            model_feed_edit item = new model_feed_edit(
