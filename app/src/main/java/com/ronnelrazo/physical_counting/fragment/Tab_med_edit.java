...
import com.ronnelrazo.physical_counting.adapter.MedTab_adapter_edit;
...
//    @BindView(R.id.nodataContainer) LinearLayout nodatacontainer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View view =  new MedTab_adapter_edit(getContext(),audit_no);//inflater.inflate(R.layout.fragment_med,parent,false);
